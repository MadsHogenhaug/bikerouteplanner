...
BASE_URL = "https://graphhopper.com/api/2/route"
####################
...
def get_route(start, end):
    ...
    """
    # GraphHopper expects points in [lat, lon] format
    ...
    data = {
        ...
        "custom_model": {
            "priority": [
                {"if": "bike_network == MISSING", "multiply_by": "0.5"},
                {"if": "urban_density == RURAL", "multiply_by": "1.5"}
            ]
        }
    }
